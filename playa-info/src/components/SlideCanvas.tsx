...
export default function SlideCanvas({
  ...
  const { theme, elements } = activeSlide;
  ...
  return (
    <div id="canvas-workspace" className="flex-1 bg-slate-50 flex flex-col items-center justify-between p-6 overflow-y-auto select-none h-full">
      {/* Top action bar */}
      ...
      <div className="w-full max-w-4xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl flex-1 flex items-center justify-center relative min-h-[360px] my-2">
        <div
          ...
          onDrop={handleDrop}
          className={`aspect-video w-full shadow-2xl rounded-2xl relative overflow-visible transition-all duration-200 flex flex-col justify-between p-12 slide-shadow ${getFontClass(theme.fontFamily)}`}
          style={{
        ...
        >
          ...
          <div id="slide-element-stack" className="flex-1 flex flex-col justify-center gap-4 py-3 overflow-visible select-none">
            {elements.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed rounded-xl p-8 transition-all" style={{ borderColor: `${theme.accent}30` }}>
              ...
              elements.map((el, index) => {
                ...
                return (
                  <div
                    ...
                    className={`p-2.5 rounded-xl cursor-pointer relative transition-all group ${
                      isSelected 
                        ? 'ring-2 ring-indigo-500 bg-black/5' 
